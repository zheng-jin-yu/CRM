...
<form class="layui-form" style="width:80%;">
    <input name="id" type="hidden" value="${(cusDevPlan.id)!}"/><#-- 这是id-->
    <input name="saleChanceId" type="hidden" value="${sid!}"/>  <#--这是sid-->
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userName" lay-verify="required" name="planItem"
                   id="planItem" value="${(cusDevPlan.planItem)!}"
                   placeholder="请输入计划项内容">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label" id="plan_time">计划时间</label>
        <div class="layui-input-block" id="planDate">
            ...
            <#else>
                <input type="date" class="layui-input userName" lay-verify="required" name="planDate" id="planDate" placeholder="请输入计划项时间">
            </#if>
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input userEmail" lay-verify="required" name="exeAffect"
                   value="${(cusDevPlan.exeAffect)!}" id="exeAffect"
                   placeholder="请输入执行效果">
        </div>
    </div>
    <br/>
